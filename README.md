...
* **Μηδενική Κατανάλωση CPU:** Εξαιρετικά ελαφρύ, πράγμα που σημαίνει ότι δεν θα επηρεάσει καθόλου την απόδοση του λογισμικού μετάδοσης ήχου (streaming software).

* **Διαχείριση BOM:** Εντοπίζει και παρακάμπτει αυτόματα τα UTF-8 Byte Order Marks (BOM) για να αποτρέψει την εμφάνιση "κινέζικων"/ακαταλαβίστικων χαρακτήρων στο stream σας.
